...
import ModalRegistrarCita from "./ModalRegistrarCita/ModalRegistrarCita";
    ...
    <>
      ...
      <div className="citas-content">
        <div className="citas-section-card">
          <h3>
            <FaCalendarAlt size={16} color="#5bb8f5" />
            Citas
          </h3>
          ...
          {cargando ? (
            ...
            <p className="citas-empty">No hay citas agendadas.</p>
          ) : (
