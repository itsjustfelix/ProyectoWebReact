...
const ModalEliminarVeterinario = ({ veterinario, onCerrar, onEliminado }) => {
  return (
    <div className="modal-overlay" onClick={onCerrar}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="modal-texto">
          ...
          <strong>{veterinario.nombre_completo}</strong>? Esta acción
...
export default ModalEliminarVeterinario;
